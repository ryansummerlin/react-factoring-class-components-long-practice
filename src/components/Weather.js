...
function Weather() {
    ...
    useEffect(() => {
      const pollWeather = async (location) => {
        ...
        // unfortunately I've been having a terrible time accessing process.env variables. I know it's bad practice
        // but I'm putting the api key in here anyways bc I don't have time to fix the .env issues
